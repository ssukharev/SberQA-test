...
SQL-запросы к таблице логов (PostgreSQL-совместимые): топ-10 пользователей по тикетам, поиск запросов с высокой задержкой. Предложения по расширению структуры логирования.
